...
<div class="col-6 bg-white border border-dark shadow border p-1 ">
    <div>
        ...
        <div>
            <?php echo $this->Form->submit('Atualizar senha', array('controller' => 'users', 'action' => 'updatepassword', 'class' => 'my-3  mt-4 form-control bg-primary text-light border border-primary border-solid ', 'style' => 'width:180px; height:40px')); ?>
        </div>
