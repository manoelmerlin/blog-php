<?= $this->Form->create('Post', array('type' => 'get')); ?>
	...
	<div class='row m-0 '>
		<div class=''>
			<?= $this->Form->input('post_name', array('label' => '', 'placeholder' => "Procure aqui a postagem que deseja ...", 'class' => '', 'style' => 'width:500px;')); ?>
			<?= $this->Form->end('pesquisar'); ?>
		</div>
	</div>
                        ...
                        <div class="col-12 border border-white p-0 div-noticias" style="height:background-color: rgba(0,0,0,0.25); background-image:  url(../../img/uploads/<?= $post["Post"]["imagem"] ?>); background-repeat: no-repeat; background-size: 100% 100%;" >
                            <center>
                                <div class="div-title mt-3 mb-3 mt-sm-5 mb-sm-5 mt-md-5 mb-md-5 mt-lg-5 mb-lg-5 mt-xl-5 mb-xl-5" style='height:100px'>
								   ...
								   <h6 style ="font-size:25px;  background-color: rgba(0,0,0,0.10);" class="div-title">
										<?php echo ($this->Html->link(substr($post['Post']['title'], 0, 100), array('controller' => 'posts',
												'action' => 'view', $post['Post']['id']), array('class' => ' text-light', 'style' => ' text-decoration:none;'))); ?>
									</h6>
                                </div>
                            </center>
